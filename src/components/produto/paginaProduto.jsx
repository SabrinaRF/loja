	...
	return (
		<main>
			...
			<div className="container mt-4">
				...
				>
					<div
						className="d-felx flex-column flex-md-row align-items-center justify-content-center justify-content-md-start mb-3 "
						style={{width: '100%', maxWidth: '900px'}}
					>
						<div className="col-md-5 text-center mb-4 mb-md-0">
							<img
								src={`https://placehold.co/630x424/000000/FFFFFF/png/?text=${produtoSelecionado.titulo}`}
						...
						<div className="col-md-7 text-center text-md-start">
							...
							<div className="d-flex align-items-center justify-content-center justify-content-md-start mb-3">
								{Array.from({length: 5}, (_, i) => (
									<svg
										...
										height="22"
										fill={
											i < produtoSelecionado.estrelas ? 'gold' : 'lightgray'
										}
							...
							<div>
								<button className="btn btn-success px-4 py-2">Comprar</button>
							</div>
						</div>
					</div>
				</div>
